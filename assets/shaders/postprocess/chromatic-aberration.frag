...
void main(){
    ...
    vec4 redSample = texture(tex, redCoord);
    vec4 greenSample = texture(tex, tex_coord);
    vec4 blueSample = texture(tex, blueCoord);
    frag_color = vec4(redSample.r, greenSample.g, blueSample.b, greenSample.a);
}